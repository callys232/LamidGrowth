...
export function AboutLeadershipHeroSlide({ embedded = false }: DocumentPageProps) {
  return <DocumentHeroSlide page={content} embedded={embedded} />;
}

/** Founder-Led Today */
export function FounderLedTodaySlide1({ embedded = false }: DocumentPageProps) {
  return (
...
export function ResponsibilityBeforeTitleSlide2({ embedded = false }: DocumentPageProps) {
  return (
    <DocumentSectionSlide
...
export function ExperienceWithContextSlide3({ embedded = false }: DocumentPageProps) {
  return (
