...
export function WhoItsForInstitutionsHeroSlide({ embedded = false }: DocumentPageProps) {
  return <DocumentHeroSlide page={content} embedded={embedded} />;
}

/** Institutional Clarity */
export function InstitutionalClaritySlide1({ embedded = false }: DocumentPageProps) {
  return (
...
export function WorkforceCapabilitySlide2({ embedded = false }: DocumentPageProps) {
  return (
    <DocumentSectionSlide
...
/** Technology Should Strengthen the Institution, Not Blur Its Responsibility. */
export function TechnologyShouldStrengthenTheInstitutionNotBlurItsResponsibilitySlide4({
  embedded = false,
}: DocumentPageProps) {
  return (
