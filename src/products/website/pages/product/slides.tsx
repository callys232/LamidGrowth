...
export function StartWithYourObjectiveSlide1({ embedded = false }: DocumentPageProps) {
  return (
...
export function ContinuousIntelligenceKeepsTheOperatingContextCurrentSlide2({
  embedded = false,
}: DocumentPageProps) {
  return (
    <DocumentSectionSlide
...
export function PersistentProgressionSlide3({ embedded = false }: DocumentPageProps) {
  return (
    <DocumentSectionSlide
...
export function OneOsDifferentRelevantDepthSlide4({ embedded = false }: DocumentPageProps) {
  return (
