...
/** /os/pricing — every billable (tool/engine, priced by points) plus purchasable bundles,
 * and an admin bundle builder that packages a set of tools + a points allotment into one price. */
  ...
  return (
    <section className="panel">
      <div className="panel-heading">
        <div>
          <h2>Pricing</h2>
          <span>Every billable tool and engine, priced in points, plus bundles that package them together.</span>
        </div>
      </div>
      ...
      <section className="panel settings-card">
        <h3>Buy points</h3>
        <p>Points cover every billable tool and engine call at the rate shown above.</p>
      ...
      <section className="panel settings-card">
        ...
        <p>Create a new bundle from the tools and engines above. Only an ecosystem administrator can publish it.</p>
