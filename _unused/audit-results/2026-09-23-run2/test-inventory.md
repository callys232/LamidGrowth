...
- PASS the 9 new commercial document tools reject a missing job/proposal before charging, without completing
- PASS the scope builder grounds its draft in the real job and rejects unrelated users
- PASS the contract builder grounds its draft in the real job and rejects unrelated users
...
- FAIL AI-human handoff: the Companion agent automatically raises a handoff for a regulated-sounding message
...
- PASS a task can be created, listed, updated and deleted by either party
- PASS overdue and blocked tasks surface in the attention feed; done tasks never do
- PASS a change request can be opened by either party and decided only by the project owner
- PASS a project can only be closed once every milestone is fully paid, and only then issues a certificate
...
- FAIL tests\browser\account-recovery.spec.ts:4:1 › local account recovery resets the password and returns to sign in (30.4s)
- FAIL tests\browser\admin-delete-account.spec.ts:4:1 › workspace administrators do not receive a permanent-delete control (30.1s)
- FAIL tests\browser\all-contexts.spec.ts:20:3 › Individual: can create and load a workspace (42.3s)
- PASS tests\browser\all-contexts.spec.ts:20:3 › Professional: can create and load a workspace (14.9s)
- PASS tests\browser\all-contexts.spec.ts:20:3 › Creator: can create and load a workspace (3.3s)
- PASS tests\browser\all-contexts.spec.ts:20:3 › Founder: can create and load a workspace (3.6s)
- PASS tests\browser\all-contexts.spec.ts:20:3 › Team: can create and load a workspace (3.9s)
- PASS tests\browser\all-contexts.spec.ts:20:3 › SME: can create and load a workspace (26.0s)
- PASS tests\browser\all-contexts.spec.ts:20:3 › Enterprise: can create and load a workspace (4.9s)
- PASS tests\browser\all-contexts.spec.ts:20:3 › Institution: can create and load a workspace (4.2s)
- PASS tests\browser\backend-boundary.spec.ts:3:1 › backend routes work while server-only source stays outside frontend delivery (62ms)
- FAIL tests\browser\commercial-knowledge.spec.ts:4:1 › workspace job posting charges once and knowledge can be edited and deleted (30.6s)
- PASS tests\browser\companion-widget.spec.ts:6:1 › visitor guidance works on mobile in both themes and restores keyboard focus (4.3s)
- PASS tests\browser\companion-widget.spec.ts:31:1 › specialist selection persists history and a coordinated plan survives reload (26.8s)
- FAIL tests\browser\consulting-project.spec.ts:4:1 › consulting project uses the implemented workspace tools end to end (12.9s)
- PASS tests\browser\design.spec.ts:3:1 › canonical palette and Three.js scene respond and settle without an idle loop (17.9s)
- PASS tests\browser\design.spec.ts:32:1 › reduced motion keeps the Three.js scene static and interface usable (2.8s)
- FAIL tests\browser\enterprise.spec.ts:4:1 › enterprise evaluation links and signup journey remain navigable (40.3s)
- FAIL tests\browser\expert-network.spec.ts:16:1 › the consolidated /experts page renders every group with its own heading (33.3s)
- FAIL tests\browser\expert-network.spec.ts:38:1 › an expert can publish availability, see it on the week calendar, and create a team (30.4s)
- PASS tests\browser\expert-network.spec.ts:63:1 › guided scoping wizard flags a regulated objective and offers expert review (5.1s)
- PASS tests\browser\goal-pathway.spec.ts:4:1 › choose a pathway, save it, and follow progress after reloading (23.3s)
- PASS tests\browser\goal-pathway.spec.ts:46:1 › human AI rules persist and block requests at the API (3.5s)
- PASS tests\browser\homepage.spec.ts:4:1 › homepage puts its main actions above the fold and the product page preview supports keyboard use (4.0s)
- PASS tests\browser\homepage.spec.ts:55:1 › homepage and product page fit narrow screens and the preview remains usable (12.5s)
- PASS tests\browser\homepage.spec.ts:78:1 › homepage explains its cycle and changes relevant depth by audience (3.4s)
- PASS tests\browser\homepage.spec.ts:120:1 › outcome choices change content without moving the viewport or panel (3.0s)
- PASS tests\browser\homepage.spec.ts:145:1 › supporting homepage details expand and collapse with keyboard access (1.8s)
- PASS tests\browser\interactions.spec.ts:3:1 › list feedback follows scrolling and supports dynamically loaded items (2.0s)
- FAIL tests\browser\journey.spec.ts:4:1 › public experience and workspace complete a connected operating cycle (7.7s)
- PASS tests\browser\journey.spec.ts:67:1 › mobile navigation and onboarding work without horizontal overflow (6.6s)
- PASS tests\browser\journey.spec.ts:116:1 › keyboard search, dialogs, and accessibility semantics (3.2s)
- PASS tests\browser\learning.spec.ts:4:1 › a learner can create a path, enroll, complete a module, and rate it (4.9s)
- PASS tests\browser\navigation.spec.ts:4:1 › mega menus expose options on hover and support keyboard navigation (3.6s)
- PASS tests\browser\theme.spec.ts:5:3 › public pages have readable text in light mode (17.4s)
- PASS tests\browser\theme.spec.ts:5:3 › public pages have readable text in dark mode (13.7s)
- PASS tests\browser\theme.spec.ts:25:1 › navbar theme choice overrides the system, persists, and fits mobile (8.4s)
- PASS tests\browser\workflows.spec.ts:4:1 › a scheduled operating cycle requires each write approval and delivers a reminder (38.5s)
- PASS tests\browser\workflows.spec.ts:62:1 › workspace switching discards stale settings and owner controls reflect membership (4.2s)
- PASS tests\browser\copy.spec.ts:29:1 › every documented route renders every original copy paragraph (1.6m)

## usability

- PASS tests\browser\regional-usability.spec.ts:19:3 › Lagos: onboarding, goal and specialist value (23.4s)
- PASS tests\browser\regional-usability.spec.ts:19:3 › Nairobi: onboarding, goal and specialist value (18.6s)
- PASS tests\browser\regional-usability.spec.ts:19:3 › London: onboarding, goal and specialist value (7.2s)
- PASS tests\browser\regional-usability.spec.ts:19:3 › New York: onboarding, goal and specialist value (15.0s)
- PASS tests\browser\regional-usability.spec.ts:19:3 › Toronto: onboarding, goal and specialist value (7.6s)
- PASS tests\browser\regional-usability.spec.ts:19:3 › Berlin: onboarding, goal and specialist value (27.6s)
- PASS tests\browser\regional-usability.spec.ts:19:3 › Mumbai: onboarding, goal and specialist value (7.7s)
- PASS tests\browser\regional-usability.spec.ts:19:3 › Dubai: onboarding, goal and specialist value (14.4s)
- PASS tests\browser\regional-usability.spec.ts:19:3 › Sao Paulo: onboarding, goal and specialist value (8.8s)
- PASS tests\browser\regional-usability.spec.ts:19:3 › Sydney: onboarding, goal and specialist value (9.9s)

## paid-path

- FAIL tests\browser\paid-path-demo.spec.ts:34:3 › Lagos-Paid: paid specialist sequence (simulated AI) (1.3m)
- FAIL tests\browser\paid-path-demo.spec.ts:34:3 › Berlin-Paid: paid specialist sequence (simulated AI) (50.2s)
- FAIL tests\browser\paid-path-demo.spec.ts:34:3 › Mumbai-Paid: paid specialist sequence (simulated AI) (49.9s)

## deep-coverage

- FAIL tests\browser\deep-coverage.spec.ts:17:3 › Amara: deep coverage across engines, companion, and the full marketplace chain (1.6m)
- FAIL tests\browser\deep-coverage.spec.ts:17:3 › Zainab: deep coverage across engines, companion, and the full marketplace chain (1.1m)

## human-pace

- FAIL tests\browser\human-pace.spec.ts:20:1 › a real first-time visitor: homepage, signup, first goal, first free outcome (1.7m)

## click-everything

- PASS tests\browser\click-everything.spec.ts:61:1 › sweep every public page: click every internal link and safe button, report what breaks (2.7m)
