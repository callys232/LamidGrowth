...
- Name: account-recovery.spec.ts >> local account recovery resets the password and returns to sign in
- Location: tests\browser\account-recovery.spec.ts:4:1
...
- main:
  ...
  - paragraph: Create your account to begin in a professional context.
  - text: Your name
  - textbox "Your name":
    - /placeholder: How should we call you?
    - text: Recovery Browser User
  - text: Email address
  - textbox "Email address":
    - /placeholder: you@example.com
    - text: recovery-1790203672575@example.test
  - text: Password
  - textbox "Password":
    - /placeholder: Create a strong password
    - text: secure-recovery-browser-password
