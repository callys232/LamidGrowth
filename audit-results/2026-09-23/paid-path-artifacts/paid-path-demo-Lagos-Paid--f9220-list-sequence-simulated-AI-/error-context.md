...
Locator:  locator('.companion-task-card').filter({ hasText: 'Plan my first client project' }).locator('.companion-task-chip-completed')
Expected: 1
Received: 0
Timeout:  45000ms

Call log:
  - Expect "toHaveCount" locator('.companion-task-card').filter({ hasText: 'Plan my first client project' }).locator('.companion-task-chip-completed') with timeout 45000ms
  - waiting for locator('.companion-task-card').filter({ hasText: 'Plan my first client project' }).locator('.companion-task-chip-completed')
